...
def generate_launch_description():
  ...
  mss_urdf = os.path.join(get_package_share_directory("iss_description"), "robots", "setups", "mobile_servicing_system_with_htv_pallet.urdf.xacro")  
  ...
  spawn_batteries = IncludeLaunchDescription(
    PathJoinSubstitution([
      FindPackageShare("iss_description"), "launch", "setups", "spawn_batteries.launch.py"
    ])
  )
